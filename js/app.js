 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".page-home__slider")) new core(".page-home__slider", {
                modules: [ Navigation, Pagination, Parallax, Scrollbar, Autoplay, Keyboard ],
                autoplay: {
                    delay: 2e3,
                ...
                parallax: true,
                pagination: {
                    el: ".controll-page-home__dotts",
                    clickable: true
                },
                navigation: {
                    nextEl: ".navigation-page-home__prev",
                    prevEl: ".navigation-page-home__next"
                },
                scrollbar: {
                    el: ".controll-page-home__scroll-bar",
                    draggable: true
                },
                keyboard: {
                    enabled: true,
                ...
                on: {
                    init: function(swiper) {
                        ...
                        const allSlidesItems = document.querySelectorAll(".slide-page-home:not(.swiper-slide-duplicate)");
            ...
            const swiper = new core(".preview-panoramic", {
                modules: [ Autoplay, Keyboard, Thumb, EffectFade ],
                observer: true,
                observeParents: true,
                freeMode: true,
                slidesPerView: 7,
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest("[data-parent]")) e.preventDefault();
        }
        document.addEventListener("click", (function(e) {
            const targetElem = e.target;
            if (targetElem.classList.contains("bottom-work__button")) {
        ...
        async function getMore(targetElem) {
            const response = await fetch("faq.html");
            if (response.ok) {
                const text = await response.text();
                const bottomWorkCards = document.querySelector(".bottom-work__cards");
                bottomWorkCards.insertAdjacentHTML("beforeend", text);
